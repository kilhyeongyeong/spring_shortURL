...
<body>
    <div class="container">
        <h1>Create New</h1>
        <form action="/shortUrl/create" method="post">
            <div>
                <p class="margin">Destination</p>
                <input type="text" class="form-control" placeholder="https://example.com/my-long-url" onchange="originUrlOnchange(this)" name="originUrl" value="${shortUrl.originUrl}">
            </div>
            <div>
